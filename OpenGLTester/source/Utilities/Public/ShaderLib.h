...
{
public:
    static std::unordered_map<ShaderType, std::pair<const std::string, const std::string>>& get()
    {
...
private:
    //first string in pair is vertex shader path, second - fragment shader path
    static std::unordered_map<ShaderType, std::pair<const std::string,const std::string>> m_shaderLibrary;
};